...
proc create_root_design { parentCell } {
  ...
  set ctr_colsel_0 [ create_bd_port -dir O -from 4 -to 0 ctr_colsel_0 ]
  set ctr_rowsel_0 [ create_bd_port -dir O -from 4 -to 0 ctr_rowsel_0 ]
  set ctrl_outsel_0 [ create_bd_port -dir O -from 3 -to 0 ctrl_outsel_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins control_mp1_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  ...
  connect_bd_net -net control_mp1_0_ctr_colsel [get_bd_ports ctr_colsel_0] [get_bd_pins control_mp1_0/ctr_colsel]
  connect_bd_net -net control_mp1_0_ctr_rowsel [get_bd_ports ctr_rowsel_0] [get_bd_pins control_mp1_0/ctr_rowsel]
  connect_bd_net -net control_mp1_0_ctrl_outsel [get_bd_ports ctrl_outsel_0] [get_bd_pins control_mp1_0/ctrl_outsel]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins UDP_1/clk100MHz] [get_bd_pins UDP_1/s00_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_0/s00_axi_aclk] [get_bd_pins clk_wiz_1/clk_out4] [get_bd_pins control_mp1_0/s00_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A20000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs control_mp1_0/S00_AXI/S00_AXI_reg] SEG_control_mp1_0_S00_AXI_reg
